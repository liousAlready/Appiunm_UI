...
w = driver.find_element(By.XPATH,
                        '//android.widget.LinearLayout[@resource-id="com.wondertek.paper:id/ths_weather_layout" and @index="1"]').text
print(w)

# 查看朋友圈是否能够点击
display = driver.find_element(By.XPATH, '//android.widget.TextView[@text="澎友圈"]').is_enabled()
print(display)
