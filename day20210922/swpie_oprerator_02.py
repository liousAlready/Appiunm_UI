...
# web_element_e1 = driver.find_element(By.XPATH, '//android.widget.TextView[@text="用户和账号"]')
#
# web_element_e2 = driver.find_element(By.XPATH, '//android.widget.TextView[@text="显示"]')
#
